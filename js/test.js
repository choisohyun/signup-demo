...
function checkPswd1() {
  ...
  $.ajax({
    type: "GET",
    url:
      "/user2/joinAjax.nhn?m=checkPswd&id=" +
...
function checkPrtsAuthnoByAjax() {
  ...
  $.ajax({
    type: "GET",
    url:
      "/user2/joinAjax.nhn?m=checkPrtsAuthno&psex=" +
      pGender +
      "&pForeign=" +
      pForeign +
      "&pbirthday=" +
...
function createRsaKey() {
  var rsa = new RSAKey();
  var sessionKey = "Ivpkav6voy11A4k3";
  var keyName = "100015250";
  var eValue =
    "";
  var nValue = "010001";
